...
export class Maintenance_Frequency extends Parse.Object<Maintenance_FrequencyAttributes> {
  static className: string = "OD3_Maintenance_Frequency";

  constructor(data?: Partial<Maintenance_FrequencyAttributes>) {
    super("OD3_Maintenance_Frequency", data as Maintenance_FrequencyAttributes);
  }
