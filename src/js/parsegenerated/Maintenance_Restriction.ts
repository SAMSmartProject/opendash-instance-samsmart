...
export class Maintenance_Restriction extends Parse.Object<Maintenance_RestrictionAttributes> {
  static className: string = "OD3_Maintenance_Restriction";

  constructor(data?: Partial<Maintenance_RestrictionAttributes>) {
    super("OD3_Maintenance_Restriction", data as Maintenance_RestrictionAttributes);
  }
